...
export const TWISTS: Twist[] = [
  ...
  },
  {
    ...
    sentence: "The entire interaction takes under a minute a day.",
  ...
  },
  {
    id: "voice",
    label: "Voice-first",
    sentence: "It is driven entirely by speaking to it.",
  ...
  },
  {
    id: "single",
    label: "One screen",
    sentence: "The whole thing lives on one screen with no navigation.",
